...
// Componente para quebrar o texto do eixo X em várias linhas sem invadir o gráfico
function CustomAxisTick({ x, y, payload }: any) {
  const words = (payload.value || "").split(" ");
  // Divide o texto em até 2 linhas caso seja longo
  ...
  return (
    <div className="space-y-5 mt-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        {/* 2. Projetos por Fase — Jornada (Barras Verticais com Quebra de Linha) */}
        <div className="panel flex flex-col p-6 h-[340px]">
          <div className="flex items-center gap-2 mb-2">
          ...
          {loading ? (
            ...
            <div className="flex-1 w-full mt-2">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  <XAxis type="number" stroke="var(--hq-text-ghost)" fontSize={10} tickLine={false} axisLine={false} />
                  <YAxis type="category" dataKey="name" stroke="var(--hq-text-ghost)" fontSize={11} tickLine={false} axisLine={false} width={80} />
                  <Tooltip
                    contentStyle={{ background: "#18181b", border: "1px solid var(--hq-hairline)", borderRadius: "8px", fontSize: "12px" }}
                  />
      ...
      {/* ── LINHA 3: Propostas — Progresso (Barra Empilhada Proporcional) ──── */}
